-- Migração final para corrigir acesso do superadmin (versão 2)
-- Esta migração corrige apenas as políticas RLS sem recriar o usuário

-- 1. Garantir que o perfil existe na tabela user_profiles (sem conflito)
...
-- Comentário final
-- Esta migração corrige as políticas RLS sem tentar recriar o usuário
