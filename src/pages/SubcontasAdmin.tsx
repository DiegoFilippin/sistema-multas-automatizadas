...
import { Building2, Settings, Users, DollarSign, Plus, Edit, RefreshCw, CheckCircle, XCircle, AlertCircle } from 'lucide-react';
                          ...
                          <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                              ...
                              <div>
                                ...
                                <p className="text-muted-foreground font-mono">{company.subconta.wallet_id}</p>
                              </div>
                              <div>
